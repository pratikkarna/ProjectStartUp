...
//        // ✅ Constructor receives connection string from BLL
...
//            using (var cmd = new SqlCommand("SELECT ID, Name, CreatedDate, IsActive FROM Tests", conn))
//            {
//                conn.Open();
...
//                "INSERT INTO Tests (Name, CreatedDate, IsActive) VALUES (@Name, @CreatedDate, @IsActive)", conn))
//            {
