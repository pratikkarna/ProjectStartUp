                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        tests.Add(new AccountGroupDTO
                        {
                            ...
                            //Source_Module = reader.IsDBNull(4) ? null : reader.GetString(4),
                            //MainGroup = reader.IsDBNull(5) ? null : reader.GetString(5),
              //              Action_Date = reader.IsDBNull(6)
              //? DateTime.MinValue
              //: Convert.ToDateTime(reader.GetString(6)),

              //              Action_Time = reader.IsDBNull(7)
              //? DateTime.MinValue
              //: Convert.ToDateTime(reader.GetString(7)),

              //              Action_Miti = reader.IsDBNull(8)
              //? DateTime.MinValue
              //: Convert.ToDateTime(reader.GetString(8)),
